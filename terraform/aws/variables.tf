...
variable "application_instance_power" {
  description = "The power of the Lightsail container service instance (nano: 0.25 vCPU/512 MB, micro: 0.5 vCPU/1 GB, small: 1 vCPU/2 GB, medium: 2 vCPU/4 GB, large: 4 vCPU/8 GB, xlarge: 8 vCPU/16 GB)"
  type        = string
  nullable    = false
  default     = "nano"
...
variable "application_instance_scale" {
  description = "The number of container service instances to run"
  type        = number
  nullable    = false
  default     = 1
